  ...
  <section>
    ...
    <form class="row g-3" action="eliminar_usuario.php" method="post">
      ...
      <div class="col-sm-6">
        ...
        <input type="text" class="form-control" name="nombre" id="nombre" value="<?php echo $fila['nombre']." ".$fila['apellido'];?>" disabled>
      </div>
      ...
      <div class="col-sm-6 mb-3">
        ...
        <input type="text" class="form-control" name="apellido" id="apellido" value="<?php echo $fila['email'];?>" disabled>
      </div>
