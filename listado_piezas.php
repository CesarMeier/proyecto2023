                    ...
                    <tr>    
                        ...
                        <td>
                            <div class="d-sm-inline-block">
                                <form action="form_editar_pieza.php" method="post"><input type="hidden" name="id" value="<?php echo $fila['idpieza'];?>"><button class="btn btn-outline-success btn-sm" type="submit" name="btneditar" id="btneditar">Editar</button></form>
                            </div>
                            <div class="d-sm-inline-block"><form action="form_eliminar_pieza.php" method="post"><input type="hidden" name="id" value="<?php echo $fila['idpieza'];?>"><button class="btn btn-outline-danger btn-sm" type="submit" name="btnborrar" id="btnborrar">Borrar</button></form>
                            </div>
                        </td>
                    </tr>
